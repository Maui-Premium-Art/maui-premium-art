...
On startup:
1. Read ~/.openclaw/workspace-kai/SOUL.md
2. Read ~/.openclaw/workspace-kai/MEMORY.md
...
Methodology: Smart-Ralph

Key reference: CT_DISPLAY_SOURCE_BRIEF.md — recreate UI in code, use Tesla 3D assets
