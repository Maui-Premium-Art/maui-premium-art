...
export const artworks: Artwork[] = [
  {
    ...
    formats: [
      { name: "Cybertruck Tailgate Wrap", price: 895 },
      { name: "Original Art Piece", price: 4995 },
      { name: "Metallic Print", price: 1295 },
      { name: "Gallery Canvas", price: 895 },
      { name: "Fine Art Print", price: 395 },
    ],
    relatedSlugs: [],
  },
];
